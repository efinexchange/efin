...
Note, Legacy Stealth Addresses are not supported on Hardware Signing Devices. If you have EFIN/tPART received on the Legacy Stealth Addresses then we suggest you send those EFIN/tPART to a non-Stealth Address before attempting to use with the Hardware Signing Devices.
